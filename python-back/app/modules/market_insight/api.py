...
from app.modules.market_insight.report_service import MARKET_REVIEW_CALCULATION_REVISION, MarketDailyReviewService
...
async def daily_review(
    ...
    calculation_version: str = Query(default=MARKET_REVIEW_CALCULATION_REVISION, min_length=1, max_length=80),
