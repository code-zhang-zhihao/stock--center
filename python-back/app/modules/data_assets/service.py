...
ASSET_DEFINITIONS: tuple[AssetDefinition, ...] = (
    ...
    asset("limit_events", "涨跌停与停复牌", "daily_fact", "t_limit_event_daily", "daily", "晚间增强", ["daily_close_enrichment_ingest", "daily_close_repair_ingest", "backfill_stock_daily_facts"], "trade_date", None, "stock_code", expected_lag_trade_days=2),
    ...
    asset("sector_bars", "板块日线", "daily_fact", "t_sector_bar", "daily", "晚间增强", ["daily_close_enrichment_ingest", "daily_close_repair_ingest", "backfill_sector_daily_facts"], "trade_date", None, "sector_code", expected_lag_trade_days=2),
    ...
    asset("stock_factor_daily", "个股标准日频因子", "derived", "t_stock_factor_daily", "daily", "晚间增强", ["daily_close_enrichment_ingest", "daily_close_repair_ingest", "backfill_stock_daily_factors"], "trade_date", None, "stock_code", "price_status = 'ready' AND technical_core_status = 'ready'", expected_lag_trade_days=2, approximate_row_count=True, coverage_scope="active_stock_daily"),
    ...
    asset("sector_leader_daily", "板块龙头", "derived", "t_sector_leader_daily", "daily", "增强因子", ["daily_close_enrichment_ingest", "daily_close_repair_ingest", "backfill_sector_daily_factors"], "trade_date", None, "sector_code", expected_lag_trade_days=3),
    asset("index_factor_daily", "指数日频因子", "derived", "t_index_factor_daily", "daily", "增强因子", ["daily_close_enrichment_ingest", "daily_close_repair_ingest", "backfill_index_daily_factors"], "trade_date", None, "index_code", expected_lag_trade_days=3),
    asset("market_summary_daily", "市场日频汇总", "derived", "t_market_summary_daily", "daily", "增强因子", ["daily_close_enrichment_ingest", "daily_close_repair_ingest", "backfill_stock_daily_factors"], "trade_date", None, "trade_date", expected_lag_trade_days=3),
    asset("market_north_flow", "市场级北向资金", "daily_fact", "t_market_north_flow_daily", "daily", "辅助确认", ["daily_close_enrichment_ingest", "daily_close_repair_ingest"], "trade_date", None, "trade_date", expected_lag_trade_days=5),
    asset("margin_summary", "市场两融汇总", "daily_fact", "t_margin_summary_daily", "daily", "辅助确认", ["daily_close_enrichment_ingest", "daily_close_repair_ingest"], "trade_date", None, "exchange", expected_lag_trade_days=5),
)
