...
ASSET_DEFINITIONS: tuple[AssetDefinition, ...] = (
    ...
    asset("stock_factor_daily", "个股日频因子", "derived", "t_stock_factor_daily", "daily", "核心/增强因子", ["daily_close_core_ingest", "daily_close_enrichment_ingest", "daily_close_repair_ingest", "backfill_stock_daily_factors"], "trade_date", None, "stock_code", expected_lag_trade_days=2, approximate_row_count=True, coverage_scope="active_stock_daily"),
    ...
    asset("technical_snapshots", "技术快照", "derived", "t_technical_indicator_snapshot", "eod", "核心因子/修复", ["daily_close_core_ingest", "backfill_stock_daily_factors"], None, "snapshot_time", "stock_code", expected_lag_trade_days=3, approximate_row_count=True, coverage_scope="active_stock_daily"),
