...
ASSET_DEFINITIONS: tuple[AssetDefinition, ...] = (
    ...
    asset("daily_basic", "每日估值与流动性", "daily_fact", "t_stock_daily_basic", "daily", "核心收盘", ["daily_close_core_ingest", "backfill_stock_daily_facts"], "trade_date", None, "stock_code", expected_lag_trade_days=2, coverage_scope="active_stock_daily"),
    asset("stock_fund_flow", "个股资金流", "daily_fact", "t_stock_fund_flow_daily", "daily", "核心收盘", ["daily_close_core_ingest", "backfill_stock_daily_facts"], "trade_date", None, "stock_code", expected_lag_trade_days=2, coverage_scope="active_stock_daily"),
